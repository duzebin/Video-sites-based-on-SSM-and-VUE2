<template>
    <div>
        <div style="background-color: #fff;border-radius:10px;box-shadow:0 0 3px #aaa">
                    ...
                    <el-table :data="comments.commentsList" :header-cell-style="{ textAlign: 'center' }"
                        ...
                        <el-table-column prop="vid" label="视频id" width="100">
                            <template slot-scope="scope">
                                <div @click="handleSeleVid(scope.row.vid)" style="color:blue;">{{ scope.row.vid }}</div>
                            </template>
                        </el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleSeleUId(uid) {
            ...
            request.get("User/getUserInfoByUid", { params: { uid: uid } }).then(res => {
        ...
        load() {
            ...
            request.get("Comments/getUserAllVideoAllCommentsListPage", { params: params }).then(res => {
