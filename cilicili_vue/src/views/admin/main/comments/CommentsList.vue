<template>
    <div>
        ...
        <div class="sear">
            ...
            <div>
                <el-select v-model="page.state" placeholder="审核状态" clearable>
                    <el-option v-for="(item, index) in audit" :label="item.name" :value="item.id" :key="index"></el-option>
                </el-select>
            </div>
        ...
        <div class="main">
            <div class="table">
                <el-table :data="comments.commentsList" :header-cell-style="{ textAlign: 'center' }"
                    ...
                    <el-table-column prop="stateName" label="当前状态" width="100" sortable />
